  ...
  const [errors,setErrors] = useState({})
    ...
    return(
        <div className="flex  w-full   bg-slate-400 ">
            <img src="https://res.cloudinary.com/dojmk32dv/image/upload/v1694755432/Market_phceg2.webp" className="h-screen"alt=""></img>
            ...
            <form onSubmit={handleSubmit} class="relative flex flex-col m-6 space-y-0 h-screen bg-white shadow-2xl rounded-2xl md:flex-row md:space-x-0">
                <div class="flex flex-col p-8 md:p-14">
                <h1 className="text-center text-2xl font-bold font-serif text-2xl">Happy shopping</h1>
                ...
                <span>
                <p className="hover:underline hover:text-blue-500" onClick={()=>nav('/')}>Already have an account?Login</p></span>
                </div>
                </div>
